<#
      ...
      Use this credentials to perform the wmi-query.
...
ForEach ($Computer in $ComputerName) {
  ...
  $Monitors = Get-WmiObject -Namespace "root\WMI" -Class "WMIMonitorID" -ComputerName $Computer -Credential $Credential -ErrorAction SilentlyContinue
